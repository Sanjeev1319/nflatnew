        ...
        post(route("sendEmailOtp", { email: data.school_email }), {
            ...
            onError: (errors) => {
                if (errors.email) {
                    setError({
                        school_email:
                            errors.email || "Error occurred while sending OTP.",
                    });
                } else {
                    setError({
                        school_email:
                        ...
                        <div className="px-10 py-7">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                <div>
                                    ...
                                    />
                                    <InputError
                                        message={errors.school_district}
                                    />
                                </div>
                                <div>
                                    <InputLabel
                            ...
                            <div>
                                ...
                                <TextInput
                                    ...
                                    onChange={(e) =>
                                        setData("school_mobile", e.target.value)
                                    }
                                ...
                                <InputError
                                    message={errors.school_mobile_otp}
                                />
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                <div>
                                    ...
                                    />
                                    <InputError
                                        message={errors.incharge_mobile}
                                    />
                                </div>
                                <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                <div>
                                    ...
                                    />
                                    <InputError
                                        message={errors.principal_mobile}
                                    />
                                </div>
                                <div>
                                    ...
                                    />
                                    <InputError
                                        message={errors.principal_email}
                                    />
                                </div>
                            </div>
                        </div>
